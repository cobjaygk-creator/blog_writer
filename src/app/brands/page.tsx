    ...
    <>
      ...
      <main className="mx-auto w-full max-w-3xl px-6 py-10">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-zinc-900">업체 등록</h1>
            <p className="mt-2 text-sm text-zinc-600">
              업체를 만들고 샘플 원문으로 문체를 학습합니다. 학습이 끝나면 포스트 등록에서 글을 만들 수 있습니다.
            </p>
          </div>
        ...
        {brands.length === 0 ? (
          <div className="mt-10 rounded-xl border border-dashed border-zinc-300 px-4 py-10 text-center">
            <p className="text-sm text-zinc-600">아직 등록된 업체가 없습니다.</p>
            <Link href="/brands/new" className="mt-4 inline-block">
              <Button>업체 만들기</Button>
            </Link>
          </div>
        ) : (
